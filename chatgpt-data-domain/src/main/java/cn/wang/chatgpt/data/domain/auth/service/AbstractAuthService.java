...
public abstract class AbstractAuthService implements IAuthService{
    ...
    /** SecretKey 替换为自己的，并且最好是通过配置的方式使用 */
    private final SecretKey secretKey = Keys.secretKeyFor(SignatureAlgorithm.HS256);
    private final Algorithm algorithm = Algorithm.HMAC256(secretKey.getEncoded());
    ...
    public AuthStateEntity doLogin(String code)
    {
        ...
        System.out.println(authStateEntity.getCode()+" "+authStateEntity.getInfo());
